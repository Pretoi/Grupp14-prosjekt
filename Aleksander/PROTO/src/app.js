...
class EventDetails extends React.Component{
  ...
  componentDidMount(){
    ...
    eventService.getEvent(currentArrID, (result) => {
      ...
      localStorage.setItem("current_arrDato", result.Dato)
...
//Dette aktiveres når du trykker på å legge til en bruker til en rolle
    function showModal(Arrangement_Rolle){
      ...
      while (ledigePersonerUL.firstChild) {
       ...
       let currentArrDato = localStorage.getItem("current_arrDato")
       eventService.getAvailableUsers(currentArrID, currentArrDato, result => {
...
//dette generer en liste over medlemer som har kompetansen en rolle krever
        if (Arrangement_Rolle.Gitt_Rolle == "Sanitet" && Ledig_pers.Rollenavn == "Hjelpekorpsprøve"  && Ledig_pers.Status == 1) {
                   ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Ambulansesjåfør" && Ledig_pers.Rollenavn == "Førerkort 160 utrykningskjøring" && Ledig_pers.Status == 1){
             ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Ambulansemedhjelper" && Ledig_pers.Rollenavn == "Førerkort 160 utrykningskjøring"){
                 ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "3-mann ambulanse" && Ledig_pers.Rollenavn == "Førerkort 160 utrykningskjøring"){
                 ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Scootersjåfør" && Ledig_pers.Rollenavn == "Kvalifisert kurs søk og redning vinter"){
                 ledigPersonListe()

   }else if (Arrangement_Rolle.Gitt_Rolle == "Scootermedhjelper" && Ledig_pers.Rollenavn == "Kvalifisert kurs søk og redning vinter"){
                         ledigPersonListe()

     }else if (Arrangement_Rolle.Gitt_Rolle == "3-mann scooter" && Ledig_pers.Rollenavn == "Kvalifisert kurs søk og redning vinter"){
                                 ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Under opplæring"){
                 ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Båtfører" && Ledig_pers.Rollenavn == "Maritimt VHF Sertifikat"){
                 ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Båtmannskap" && Ledig_pers.Rollenavn == "Kvalifisert sjøredningskurs"){
                 ledigPersonListe()

       }else if (Arrangement_Rolle.Gitt_Rolle == "Båtmedhjelper" && Ledig_pers.Rollenavn == "Kvalifisert sjøredningskurs"){
                   ledigPersonListe()

     }else if (Arrangement_Rolle.Gitt_Rolle == "ATV-fører" && Ledig_pers.Rollenavn == "Kvalifisert ATV kurs"){
                             ledigPersonListe()

     }else if (Arrangement_Rolle.Gitt_Rolle == "Distriktsensor" && Ledig_pers.Rollenavn == "Distriktsensorkurs"){
                              ledigPersonListe()
...
//Dette eliminerer dobble innlegg fra databsen, i tilfelle feil
          function ledigPersonListe() {
            var forsoktboks=false

            for(var i=0;i<forsokt.length;i++){
              if(PersRolleID==forsokt[i]){
                forsoktboks=true
                }
              }
    ...
    if (!forsoktboks) {
      ...
      forsokt.push(PersRolleID);

//dette generer liste over tilgjengelige medlemer og knapp for å legge dem til
...
// Generer Mal ut i fra valge parameter
